    ...
    <section id="main">
  	  ...
  	  %>
                                    <tr>
  										 ...
  										 <tr>    
    									 <td><%=list.get(ID-1).getId() %></td>
    									<td><%=list.get(ID-1).getNumber() %></td>
   					 					<td><%=list.get(ID-1).getName() %></td>
   		 								<td><%=list.get(ID-1).getGrade() %></td>
   			 							<td><%=list.get(ID-1).getMajor() %></td>
    									<td><%=list.get(ID-1).getClas() %></td>
   							 			<td><%=list.get(ID-1).getPosition() %></td>
   									 </tr>
 									 <%  
