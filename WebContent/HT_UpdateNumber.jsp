        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-9 ">
                                    	  ...
                                    	  <% 
  	 		Show_Student stu=new Show_Student();
  	 		int ID=Integer.parseInt(request.getParameter("id"));
  		//	user=model. load(ID);
  			request.setAttribute("student", stu.load(ID));
  			
  			//System.out.println(user.getName());
  	  %>
                         
                                
                                  <form action="HT_UpdateSuccess.jsp" method="post"> 
                                 <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                        <td><input type="text" name="id" value ="<%=ID%>" style="width:74px;height:38"></td>
                                        <td><input type="text" name="number" value="${student.number}" style="width:121px;height:38"></td>
                                        <td><input type="text" name="name" value ="${student.name}" style="width:72px;height:38"></td>
                                        <td><input type="text" name="grade" value ="${student.grade}" style="width:61px;height:38"></td>
                                        <td><input type="text" name="major" value ="${student.major}" style="width:56px;height:38"></td>
                                        <td><input type="text" name="clas" value="${student.clas}"style="width:56px;height:38"></td>
                                        <td><input type="text" name="position" value="${student.position}" style="width:91px;height:38"></td>
