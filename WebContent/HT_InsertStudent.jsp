        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-9 ">
                                ...
                                <form action="HT_InsertSuccess.jsp" method="post"> 
                                 <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                        <td><input type="text" name="id" style="width:74px;height:38"></td>
                                        <td><input type="text" name="number" style="width:121px;height:38"></td>
                                        <td><input type="text" name="name" style="width:72px;height:38"></td>
                                        <td><input type="text" name="grade" style="width:61px;height:38"></td>
                                        <td><input type="text" name="major" style="width:56px;height:38"></td>
                                        <td><input type="text" name="clas" style="width:56px;height:38"></td>
                                        <td><input type="text" name="position" style="width:91px;height:38"></td>
