...
<body>
 ...
 // request.setAttribute("students",list);
  ...
  <li> <a href = "QT_ShowStudent.jsp?num=0" >首页</a> </li> 
	<li><a href = "QT_ShowStudent.jsp?num=<%=prev%>" >上一页</a></li>  
	<li><a href = "QT_ShowStudent.jsp?num=<%=next%>" >下一页</a> </li> 
	<li><a href = "QT_ShowStudent.jsp?num=<%=last%>" >尾页</a> </li> 
